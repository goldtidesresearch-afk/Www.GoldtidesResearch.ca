// src/index.js
// Cloudflare Worker (with static assets) — serves the Goldtide Research site and
// handles order submissions from checkout.html.
//
// Required secrets (set in Cloudflare dashboard → this project → Settings → Variables and Secrets):
...
export default {
  async fetch(request, env) {
    ...
    // Everything else — HTML pages, CSS/JS inline in those pages, images — is a static asset.
