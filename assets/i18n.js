  ...
  window.UI_I18N = {
    en: {
      ...
      "shipping.p.contact": "For any shipping or order question, reach us at <a href=\"mailto:goldtidesresearch@gmail.com\" class=\"inline-link\">goldtidesresearch@gmail.com</a>.",
            "coa.eyebrow": "Purity & Testing", "coa.title": "COA Lookup",
      "coa.subtitle": "Every batch we sell is tested by an independent lab. Enter the batch number printed on your vial's label to pull up that batch's actual results — not a general claim, the specific report for what's in your hand.",
      "coa.inputLabel": "Batch / Lot Number", "coa.inputPlaceholder": "e.g. GT-2026-0001", "coa.searchBtn": "Look Up →",
      "coa.hint": "Your batch number is on the vial label, usually just below the compound name and size.",
      "coa.note.strong": "Can't find your batch?",
      "coa.note.body": "Not every batch is loaded here yet. Email us at <a href=\"mailto:goldtidesresearch@gmail.com\" class=\"inline-link\">goldtidesresearch@gmail.com</a> with your batch number and we'll send the report directly.",
      "coa.result.notFoundTitle": "No record found for that batch",
      "coa.result.notFoundBody": "We couldn't find \"{batch}\" in our records yet. Double-check the number on your label, or email us and we'll send the report directly.",
    ...
    fr: {
      ...
      "shipping.p.contact": "Pour toute question relative à la livraison ou à une commande, contactez-nous à <a href=\"mailto:goldtidesresearch@gmail.com\" class=\"inline-link\">goldtidesresearch@gmail.com</a>.",
            "coa.eyebrow": "Pureté et tests", "coa.title": "Recherche de COA",
      "coa.subtitle": "Chaque lot que nous vendons est testé par un laboratoire indépendant. Entrez le numéro de lot inscrit sur l'étiquette de votre flacon pour accéder aux résultats réels de ce lot — pas une allégation générale, le rapport spécifique de ce que vous avez en main.",
      "coa.inputLabel": "Numéro de lot", "coa.inputPlaceholder": "ex. GT-2026-0001", "coa.searchBtn": "Rechercher →",
      "coa.hint": "Votre numéro de lot se trouve sur l'étiquette du flacon, généralement juste sous le nom et le format du composé.",
      "coa.note.strong": "Vous ne trouvez pas votre lot ?",
      "coa.note.body": "Tous les lots ne sont pas encore chargés ici. Écrivez-nous à <a href=\"mailto:goldtidesresearch@gmail.com\" class=\"inline-link\">goldtidesresearch@gmail.com</a> avec votre numéro de lot et nous vous enverrons le rapport directement.",
      "coa.result.notFoundTitle": "Aucun résultat trouvé pour ce lot",
      "coa.result.notFoundBody": "Nous n'avons pas trouvé « {batch} » dans nos registres pour le moment. Vérifiez le numéro sur votre étiquette, ou écrivez-nous et nous vous enverrons le rapport directement.",
    ...
    es: {
      ...
      "shipping.p.contact": "Para cualquier pregunta sobre envíos o pedidos, contáctanos en <a href=\"mailto:goldtidesresearch@gmail.com\" class=\"inline-link\">goldtidesresearch@gmail.com</a>.",
            "coa.eyebrow": "Pureza y Pruebas", "coa.title": "Búsqueda de COA",
      "coa.subtitle": "Cada lote que vendemos es probado por un laboratorio independiente. Ingresa el número de lote impreso en la etiqueta de tu vial para acceder a los resultados reales de ese lote — no una afirmación general, el informe específico de lo que tienes en tus manos.",
      "coa.inputLabel": "Número de Lote", "coa.inputPlaceholder": "ej. GT-2026-0001", "coa.searchBtn": "Buscar →",
      "coa.hint": "Tu número de lote está en la etiqueta del vial, generalmente justo debajo del nombre del compuesto y el tamaño.",
      "coa.note.strong": "¿No encuentras tu lote?",
      "coa.note.body": "No todos los lotes están cargados aquí todavía. Escríbenos a <a href=\"mailto:goldtidesresearch@gmail.com\" class=\"inline-link\">goldtidesresearch@gmail.com</a> con tu número de lote y te enviaremos el informe directamente.",
      "coa.result.notFoundTitle": "No se encontró registro para ese lote",
      "coa.result.notFoundBody": "Todavía no encontramos «{batch}» en nuestros registros. Verifica el número en tu etiqueta, o escríbenos y te enviaremos el informe directamente.",
